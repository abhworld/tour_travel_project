                  ...
                  <div class="blog-page-left">
                     <div class="single-blog-item blog-single-page">
                        <div class="blog-image">
                           <img src="<?php echo base_url();?>assets/frontend_asset/img/blog-2.jpg" alt="blog" />
                        </div>
                        <div class="blog-desc">
                           <div class="post-meta">
                              ...
                              <div class="row">
                                 <div class="col-lg-6 col-sm-6">
                                    <div class="destination-desc-img">
                                       <img src="<?php echo base_url();?>assets/frontend_asset/img/gallery-2.jpg" alt="gallery 1">
                                    </div>
                                 </div>
                                 <div class="col-lg-6 col-sm-6">
                                    <div class="destination-desc-img">
                                       <img src="<?php echo base_url();?>assets/frontend_asset/img/gallery-3.jpg" alt="gallery 1">
                                    </div>
                                 </div>
                              </div>
                           </div>
