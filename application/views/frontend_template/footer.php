                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="footer-logo">
                            <a href="index.html">
                                <img src="<?php echo base_url();?>assets/frontend_asset/img/footer-logo.png" alt="abh" />
                            </a>
                        </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-footer">
                            ...
                            <div class="payment_image">
                                <img src="<?php echo base_url();?>assets/frontend_asset/img/creditcard-logo.png" alt="Payment Card" />
                            </div>
                        </div>
                    </div>
                </div>
