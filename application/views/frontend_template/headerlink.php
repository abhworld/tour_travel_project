    ...
    <!-- Title -->
    <title><?php echo $title;?> <?php echo $company_info['company_name'];?></title>
    
    <!--Bootstrap css-->
    <link rel="stylesheet" href="<?php echo base_url();?>assets/frontend_asset/css/bootstrap.css">
    <!--Font Awesome css-->
    <link rel="stylesheet" href="<?php echo base_url();?>assets/frontend_asset/css/font-awesome.min.css">
    <!--Flaticon css-->
    <link rel="stylesheet" href="<?php echo base_url();?>assets/frontend_asset/flaticon/flaticon.css">
    <!--Animatedheadline css-->
    <link rel="stylesheet" href="<?php echo base_url();?>assets/frontend_asset/css/jquery.animatedheadline.css">
    <!--Magnific css-->
    ...
    <!--Animate css-->
    <link rel="stylesheet" href="<?php echo base_url();?>assets/frontend_asset/css/animate.min.css">
    <!--Datepicker css-->
