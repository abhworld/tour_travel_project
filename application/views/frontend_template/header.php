                        ...
                        <div class="header_inn">
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="site-logo">
                                        <a href="index.php">
                                            <img src="<?php echo base_url();?>assets/frontend_asset/img/logo.png" alt="abh" />
                                        </a>
                                    </div>
                                    ...
                                    <div class="mainmenu">
                                        <nav>
                                            <ul id="navigation_menu">
                                                ...
                                                <li>
                                                    <a href="<?php echo base_url();?>omrah-homepage">Omrah</a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="<?php echo base_url();?>tour-homepage">Tour</a>
                                                </li>
