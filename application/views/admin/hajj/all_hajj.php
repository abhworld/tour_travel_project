    ...
    <div class="box">
        <div class="row no-gutters">
            <div class="col text-left">
                <div class="add-new">
                    <a href="add-hajj">Add New<i class="fas fa-plus"></i></a>
                </div><!-- End add-new-->
            </div><!-- End column-->
        ...
        <div class="row no-gutters">
            <div class="col">
                <table id="example" class="display table-hover table-responsive-xl listing">
                    ...
                    <tbody>
                        <?php $i = 1;foreach ($all_hajj as $hajj) {?>
                        <tr>
                            <td><?php echo $i;?></td>
                            <td>
                                <?php echo $hajj['package_name']?>
                            </td>
                            
                            <td>
                                <?php if(has_permission($this->type, 'edit-hajj')) {?>
                                <a href="edit-hajj/<?php echo $hajj['hajj_id']?>"><i class="fas fa-edit"></i></a>
                                <?php }if(has_permission($this->type, 'delete-hajj')) {?>
                                <a href="delete-data/4/<?php echo $hajj['hajj_id']?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fas fa-trash-alt"></i></a>
                                <?php }?>
                            </td>
                        </tr>
                        <?php $i++;}?>
