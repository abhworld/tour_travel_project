    ...
    <div class="box">
        ...
        <div class="hotel-listing-form">
            ...
            <form class="text-center" id="add_news_info">
                ...
                <input type="hidden" name="news_id" value="<?php echo $news_info[0]['news_id'];?>">
                ...
                <div class="form-row">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <select class="custom-select" name="category_id" id="category_id">
                                    ...
                                    <option value="<?php echo $category['id']?>" <?php if($news_info[0]['category_id'] == $category['id']){echo 'selected';}?>>
                    ...
                    <div class="col-md" id="hotel_name">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="news_title" required value="<?php echo $news_info[0]['news_title'];?>">
                        </div>
                    </div>
                ...
                <div class="form-row">
                    <div class="col-md">
                        ...
                        <textarea class="editor" name=""><?php echo $news_info[0]['news_description'];?></textarea>
                ...
                <div class="form-row">
                    <div class="col-md">
                        ...
                        <input type="file" id="input-file-now" class="dropify" name="userfile[]" data-default-file="uploads/news/<?php echo $news_info[0]['image'];?>"/>
                        <input type="hidden" name="prev_hotel_image" value="<?php echo $news_info[0]['image'];?>"/>
                    </div>
                </div>
