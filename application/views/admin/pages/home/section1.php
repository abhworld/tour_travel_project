<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Edit Section 1</h5>
        ...
        <form id="section_<?php echo $section_id;?>">
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="text" required id="" style="border: 1px solid #ced4da;" value="<?php if(isset($section_content['text'])){echo $section_content['text'];}?>">
                </div>
                <div class="form-group">
